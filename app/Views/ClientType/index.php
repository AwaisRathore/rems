...
<div class="card">
    <h5 class="card-header">Client Types</h5>
    <div class="card-body">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="<?= site_url("ClientType/edit/" . $value["Id"] . "") ?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                        <a class="dropdown-item" href="<?= site_url("ClientType/delete/" . $value["Id"] . "") ?>"><i class="bx bx-trash me-1"></i> Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
