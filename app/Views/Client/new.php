...
<?= $this->section('title') ?> Remote Estimation | New Client <?= $this->endSection() ?>
<?= $this->section('content') ?>
<div class="card">
    <h5 class="card-header">Add New Client</h5>
    <div class="card-body">
        <form action="add" id="submit-form" method="post">
            <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        $(".menu-inner>li.menu-item:nth-of-type(3)>.menu-sub>li.menu-item:nth-of-type(2)").addClass("active");
